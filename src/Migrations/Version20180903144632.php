 ...
 */
final class Version20180903144632 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO book (id , book_id , book_name, pub_id, book_price) VALUES("1","1","ZEESHANFOREST","10","40")');
